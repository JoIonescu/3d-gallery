...
export const PAINTINGS = [
  ...
  },
  {
    ...
    year: '2026',
    medium: 'Mixed media, watercolor blocks, gelli plate print, markers on paper',
    dimensions: '90 × 60 cm',
    description: 'Gesture, repetition, and layered texture create a sense of inner dialogue, where thought, intuition, and observation coexist but never fully align.',
