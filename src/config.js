...
export const PAINTINGS = [
  ...
  {
    id: 16,
    title: 'Midnight Within',
    year: '2026',
    medium: 'Mixed media on paper (watercolor pencils, acrylic markers, fine liners)',
    dimensions: '',
    description: 'A poetic interplay between portrait and cityscape, where a quiet inner world transforms into a luminous, dreamlike night.',
